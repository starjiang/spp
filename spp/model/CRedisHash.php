...
class CRedisHash
{
    ...
    {
        return $this->redis->hMSet($this->prefix, $obj);
    }
    ...
    {
        return $this->redis->hDel($this->prefix, $id);
    }
    ...
    {
        return $this->redis->hIncrBy($this->prefix, $key, $value);
    }

    public function keysAll($regx)
    {
        return $this->redis->keys($regx);
    }
